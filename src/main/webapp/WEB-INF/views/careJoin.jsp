...
<body data-spy="scroll" data-target=".navbar-collapse" style="font-family: SUIT-Medium;">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="U_join.html">복지사 등록</a></li>
    ...
    <section style="padding: 50px; margin-left:250px; margin-right:250px">
        <form action="" style="background-color: rgba(251, 195, 91, 0.469); border-radius: 30px;">
            <br>
            <br>
            <h3 style="text-align: center; color: rgb(93, 91, 91);">사용자 등록</h3>
            <hr>
            <div style="margin-left: 200px; margin-right: 200px;">
                <br>
                <div class="mb-3">
                    <label for="disabledTextInput" id="inputPassword6" class="form-label">관리자 아이디</label>
                    <input type="text" class="form-control" placeholder="복지사 아이디를 입력하세요" name="c_manager_id">
                </div>
                <br>
                <div class="mb-3">
                    <label for="disabledTextInput" id="inputPassword6" class="form-label">이름</label>
                    <input type="text" class="form-control" placeholder="이름을 입력하세요" name="c_name">
                </div>
                <br>
                <div class="mb-3">
                    <label for="disabledTextInput" id="inputPassword6" class="form-label">생년월일</label>
                    <input type="date" class="form-control" placeholder="생년월일을 선택하세요" name="c_birth">
                </div>
                <br>
                <div class="mb-3">
                    <label for="disabledTextInput" id="inputPassword6" class="form-label">전화번호</label>
                    <input type="text" class="form-control" placeholder="공백 없이 전화번호를 입력하세요" name="c_phone">
                </div>
                <br>
                <div class="mb-3">
                    <label for="disabledTextInput" id="inputPassword6" class="form-label">주소</label>
                    <input type="text" class="form-control" placeholder="주소를 입력하세요" name="c_address">
                </div>
                <br>
                <div class="mb-3">
                    <label for="disabledTextInput" id="inputPassword6" class="form-label">메모</label>
                    <textarea class="form-control" placeholder="특이사항을 입력하세요" name="c_memo">
                    </textarea>
                </div>
                <br>
                <br>
